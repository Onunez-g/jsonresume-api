...
func GetRoutes() *gin.Engine {
	...
	//Basics/Location
	r.GET("/resume/basics/location", controllers.GetLocation)
	r.HEAD("/resume/basics/location", controllers.GetLocation)
	auth.PUT("/resume/basics/location", controllers.PutLocation)
	auth.PATCH("/resume/basics/location", controllers.PatchLocation)
	auth.DELETE("/resume/basics/location", controllers.DeleteLocation)
